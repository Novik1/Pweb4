...
function Register() {
    ...
    return (
        <Layout>
            <div><h1 align="center" className="mainheader">LET'S REGISTER IN QUIZ APPLICATION!</h1></div>
            <div className="card">
                ...
                <div className="card-body">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <Link href="/account/login" className="btn text-success btn-link">Cancel</Link>
                    </form>
                </div>
            </div>
        </Layout>
